...
type Liquidacion = { id: number; obra_id: number; semana_etiqueta: string; fecha_pago: string; total_pagado: number; archivo_url: string | null; created_at: string | null; obra_nombre: string };
